...
--
-- Dumping data for table `wp_domain_mapping_logins`
--

LOCK TABLES `wp_domain_mapping_logins` WRITE;
/*!40000 ALTER TABLE `wp_domain_mapping_logins` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_domain_mapping_logins` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-09-25 21:39:26
