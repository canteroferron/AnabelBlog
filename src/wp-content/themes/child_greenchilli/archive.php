	...
	<div class="content">
		<article class="article">
			<div id="content_box">
			     <h1 class="postsby">
						<?php if (is_tag()) { ?> 
							<span><?php _e("Search Result for Tag: ", "mythemeshop"); ?><?php single_tag_title(); ?></span>
				...
				<?php } ?>
                                <div class="home_post_container_child">                                  
                                    <h2 class="title">
                                        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" rel="bookmark"><?php the_title(); ?></a>
                                    </h2>
                                    <div class="post-info">
                                    <?php _e('By ','mythemeshop'); the_author_posts_link(); ?><?php _e(' On ','mythemeshop'); the_time('j F Y'); ?>  
                                    </div>
    ...
    <div class="comment_cont">
        <a class="comment-icon" href="<?php comments_link(); ?>" rel="nofollow">
	        <span class="commentnumber">
	            <?php 
	               comments_number(
                       '0 '.__('Comments', 'mythemeshop'),
                       '1 '.__('Comment', 'mythemeshop'),
