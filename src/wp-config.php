...
define( 'WPCACHEHOME', '/usr/home/consultorioyorientacionpsicologica.es/web/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('WP_MEMORY_LIMIT', '64M');

define('DB_NAME', 'anabelblog');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'mycon845');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', '95X5lC76');
...
/**
 * Configuración para multisite.
 */
define('WP_ALLOW_MULTISITE', true);
define('MULTISITE', true);
define('SUBDOMAIN_INSTALL', true);
define('DOMAIN_CURRENT_SITE', 'consultorioyorientacionpsicologica.es');
define('PATH_CURRENT_SITE', '/');
define('SITE_ID_CURRENT_SITE', 1);
define('BLOG_ID_CURRENT_SITE', 1);

/**
 * Configuracion del plugin MU Domain Mapping
 */
define( 'SUNRISE', 'on' );
